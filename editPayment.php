...
include'connection.php';
	...
	$sql = "SELECT recipt_no, client_id, month, amount, year, fine, agent_id from payment where recipt_no='$recipt_no'";
	...
	while($row = $result->fetch_assoc()) {
		...
		echo "<input type=\"text\" recipt_no=\"fname\" name=\"year\" placeholder=\"Fine..\" value=\"$row[year]\">";
		echo "<label for=\"fname\">YEAR</label>";
		echo "<input type=\"text\" recipt_no=\"fname\" name=\"fine\" placeholder=\"year..\" value=\"$row[fine]\">";
