...
<body>
    ...
    <div id="page-wrapper">
        ...
        if ($_SESSION['is_admin'] == 1) {
            $sql = "SELECT recipt_no,client_id,month,amount,year,fine, agent_id FROM payment";
        } else {
            $sql = "SELECT recipt_no,client_id,month,amount,year,fine, agent_id FROM payment WHERE agent_id = '$username'";
        }
